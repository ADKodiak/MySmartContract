...
target_address = '0x5107c056db49a64b2FfCf0A2c3A0dd843FBb0794'
...
# Appel de la fonction createProposal pour mint 100 tokens à une adresse cible

amount = 50 * (10 ** 18)  # Le montant des tokens à mint
isMint = False  # True pour mint, False pour burn

tx = contract.functions.createProposal(amount, target_address, isMint).build_transaction({
    'chainId': 11155111,  
    'gas': 2000000,
