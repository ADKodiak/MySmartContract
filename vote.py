...
from_address = '0x5107c056db49a64b2FfCf0A2c3A0dd843FBb0794'
...
proposalId = 6
support = False
tx = contract.functions.vote(proposalId,support).build_transaction({
    'chainId': 11155111,  # Remplacer par le chainId du réseau utilisé
    'gas': 500000,
